...
export function wledClientPlugin(client:WLEDClient):Plugin {
	...
	const client_api:VueWLEDClient = {
		...
		refreshState: client.refreshState.bind(client),
		refreshInfo: client.refreshInfo.bind(client),
		refreshEffects: client.refreshEffects.bind(client),
		refreshPalettes: client.refreshPalettes.bind(client),
		refreshPresets: client.refreshPresets.bind(client),
